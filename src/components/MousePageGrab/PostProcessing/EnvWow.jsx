...
export function EnvWow({ customLighting = null }) {
  ...
  useEffect(() => {
    ...
    Promise.resolve().then(async () => {
      ...
      let swEffect1 = new POSTPROCESSING.ShockWaveEffect(
        camera,
        new Vector3(0, 0, 0),
        {
          speed: 0.75,
      ...
      let swEffect2 = new POSTPROCESSING.ShockWaveEffect(
        camera,
        new Vector3(0, 0, 0),
        {
          speed: 0.75,
      ...
      let swEffect3 = new POSTPROCESSING.ShockWaveEffect(
        camera,
        new Vector3(0, 0, 0),
        {
          speed: 0.75,
      ...
      let swEffect4 = new POSTPROCESSING.ShockWaveEffect(
        camera,
        new Vector3(0, 0, 0),
        {
          speed: 0.75,
      ...
      let swEffect5 = new POSTPROCESSING.ShockWaveEffect(
        camera,
        new Vector3(0, 0, 0),
        {
          speed: 0.75,
      ...
      let idx = 0;
      let waves = [swEffect1, swEffect2, swEffect3, swEffect4, swEffect5];
