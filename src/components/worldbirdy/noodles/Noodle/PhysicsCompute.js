...
export class PhysicsCompute {
  ...
  constructor({ tracker, sizeX, sizeY, gl } = {}) {
    ...
    let posIdx = new DataTexture(posIdx_data, SIZE_X, SIZE_Y, RGBAFormat, FloatType)
    ...
    let posDynamic = new DataTexture(posDynamic_data, SIZE_X, SIZE_Y, RGBAFormat, FloatType)
