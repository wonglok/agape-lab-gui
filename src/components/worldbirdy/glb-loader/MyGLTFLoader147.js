  ...
  loadMesh(meshIndex) {
    ...
    return Promise.all(pending).then(function (results) {
        ...
        if (
          ...
          let onBeforeCompile = (shader, gl) => {
            ...
            let rAF = () => {
              ...
              shader.uniforms.resolution.value.x = window.innerWidth * window.devicePixelRatio
              shader.uniforms.resolution.value.y = window.innerHeight * window.devicePixelRatio
      ...
      `
            ...
            shader.vertexShader = shader.vertexShader.replace(`#include <fog_vertex>`, `#include <fog_vertex>${atEndV}`)
...
function toTrianglesDrawMode(geometry, drawMode) {
  ...
  if (index === null) {
    ...
    if (position !== undefined) {
      ...
      console.error('THREE.MyGLTFLoader.toTrianglesDrawMode(): Undefined position attribute. Processing not possible.')
      return geometry
    }
  }
  ...
  if (newIndices.length / 3 !== numberOfTriangles) {
    console.error('THREE.MyGLTFLoader.toTrianglesDrawMode(): Unable to generate correct amount of triangles.')
  }
