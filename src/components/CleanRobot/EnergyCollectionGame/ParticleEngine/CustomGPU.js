 ...
 * let vellet = gpuCompute.addVariable( "textureVelocity", fragmentShaderVel, pos0 );
 * let poslet = gpuCompute.addVariable( "texturePosition", fragmentShaderPos, vel0 );
 *
 * // Add variable dependencies
 * gpuCompute.setVariableDependencies( velVar, [ velVar, poslet ] );
 * gpuCompute.setVariableDependencies( posVar, [ velVar, poslet ] );
 *
 * // Add custom uniforms
 ...
 * myMaterial.uniforms.myTexture.value = gpuCompute.getCurrentRenderTarget( poslet ).texture;
 *
 * // Do your rendering
